...
<!--              *Hotel Booking * Flight Booking * Cruise Booking-->
                   <img src="images/holiday.jpg" alt="Hotel image" class="image" height="200px" width="350px">
                   <img src="images/planeservices.jpg" alt="Hotel image" class="image" height="200px" width="350px">
                   <img src="images/cruise2.jpg" alt="Hotel image" class="image" height="200px" width="350px">
              
            <div class="container-fluid">
            <div class="container">
<!--                   <img src="images/holiday.jpg" alt="Hotel image" class="image" height="200px" width="500px">-->
                
<!--
                   <div class="overlay">
                      <div class="text"><a href="hb.php"> Book Hotel  &nbsp;&nbsp;Room in just ONE CLICK!</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; <a href="fb.php">Book Flights Tickets in just ONE CLICK!</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;<a href="cb.php"> Book Cruise &nbsp;&nbsp;Tickets in just  ONE CLICK!</a></div> 
...
<!--                   </div>-->
                ...
                <div class="container">
<!--                  <img src="images/planeservices.jpg" alt="Plane Image" class="image">-->
                   <div class="overlay">
<!--                    <div class="text"><a href="flightbooking.html">Book Flights Tickets in just ONE CLICK!</a></div>-->
                    </div>
...
<!--                   <div class="text"><a href="cruisebooking.html"> Book Cruise &nbsp;&nbsp;Tickets in just  ONE CLICK!</a></div>-->
            ...
            <center> <h2> <a href="package-list.php"> Our Packages</a> </h2> </center>
<!--              <h2>Our Packages-</h2>-->
              </section>
