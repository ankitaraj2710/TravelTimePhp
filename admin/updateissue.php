...
$sql = "UPDATE tblissues SET AdminRemark=:remark WHERE  id=:id";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      ...
      <td colspan="2" >  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
            ...
            <tbody>
<?php 
$sql = "SELECT * from tblissues where id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id',$id, PDO::PARAM_STR);
$query->execute();
...
?>
     ...
     <tr style=''>
      ...
      <td class="fontkink" align="justify" ><span class="fontkink">
        <textarea cols="50" rows="7" name="remark" required="required" ><?php echo htmlentities($result->AdminRemark);?></textarea>
        </span></td>
    </tr>
    <tr>
