...
<html>
<head>
<title>FT | Admin manage Bookings</title>
...
<a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" ><img src="images/x-button.svg"></a> <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to Confirm booking')" ><img src="images/check.svg"></a></td>
<?php }?>
