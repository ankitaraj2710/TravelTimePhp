...
<div class="left-content">
      ...
      <ol class="breadcrumb">
          <li class="breadcrumb-item"><a   href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Add Users</li>
      </ol>
      <div class="agile-grids">	
          ...
          ?>
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
              <form id="adduser" name="adduser" method="post" action="" novalidate>
              <div class="form-group input-group">
                ...
                <select class="custom-select" name="mcode" style="max-width: 75px;float:left;padding:6px 4px">
                  ...
                  <input style="float:left;width: 85%;" required class="form-control"  placeholder="Mobile number" maxlength="10" minlength="5" maxlength="10" name="mobilenumber"  type="text">
                </div> <!-- form-group// -->
                <!-- form-group end.// -->
                <div class="form-group input-group">
                ...
                <div class="form-group">
                  <button  name="submit" id="submit" class="btn btn-primary btn-block"> Create User  </button>
                </div> <!-- form-group// -->      
            </form>
            </article>
          </div>
