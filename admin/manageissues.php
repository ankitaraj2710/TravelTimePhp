...
<html>
<head>
<title>FT | Admin manage Issues</title>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('<?=$_SERVER['HOST']?>/foverotours/admin/updateissue.php?id=<?php echo ($result->id);?>');">View </a>
</td>
