...
<div class="rooms">
	<div class="container">
		...
		<div class="room-bottom">
			<h3><?php 	if(isset($_GET['search'])&&$_GET['search']!=''){
				 echo "Showing you results for ".$_GET['search'];
				 }else{ 
					 echo "All Packages";
					 }
					 ?>
			...
			if(isset($_GET['search'])){
				$cond= "WHERE PackageLocation Like '%".$_GET['search']."%'";
			}
			$sql = "SELECT * from tbltourpackages ".$cond;
